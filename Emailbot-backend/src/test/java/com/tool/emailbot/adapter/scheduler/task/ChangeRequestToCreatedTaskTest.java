...
/**
 * Test for the class {@link ChangeRequestToCreatedTask}.
 *
 * @author Jovani Rico (jovanimtzrico@gmail.com)
 */
public class ChangeRequestToCreatedTaskTest extends PersistenceTest {
    ...
    @Inject 
    private ChangeRequestToCreatedTaskTest createdTask;
